...
import com.yovvis.easyopenappservice.scoring.ScoringStrategyExecutor;
...
import com.yovvis.easyopenmodel.dto.useranswer.UserAnswerAddRequest;
import com.yovvis.easyopenmodel.dto.useranswer.UserAnswerEditRequest;
import com.yovvis.easyopenmodel.dto.useranswer.UserAnswerQueryRequest;
import com.yovvis.easyopenmodel.dto.useranswer.UserAnswerUpdateRequest;
...
public class UserAnswerController {
    ...
    public BaseResponse<Boolean> deleteUserAnswer(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldUserAnswer.getUserId().equals(user.getId()) && !userService.isAdmin(user)) {
