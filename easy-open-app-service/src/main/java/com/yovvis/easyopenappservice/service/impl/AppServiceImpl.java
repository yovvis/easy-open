...
import com.yovvis.easyopenappservice.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(StrUtil.isBlank(appDesc), ErrorCode.PARAMS_ERROR, "应用描述不能为空");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        queryWrapper.like(StrUtil.isNotBlank(appDesc), "appDesc", appDesc);
        queryWrapper.like(StrUtil.isNotBlank(reviewMessage), "reviewMessage", reviewMessage);
        // 精确查询
        queryWrapper.eq(StrUtil.isNotBlank(appIcon), "appIcon", appIcon);
    ...
    public Page<AppVO> getAppVOPage(Page<App> appPage, HttpServletRequest request) {
        ...
        appVOList.forEach(appVO -> {
            ...
            appVO.setUser(userFeignClient.getUserVO(user));
        });
        // endregion
