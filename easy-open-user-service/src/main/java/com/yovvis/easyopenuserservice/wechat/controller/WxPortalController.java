...
import com.yovvis.easyopenuserservice.wechat.service.WxMessageService;
...
public class WxPortalController {
    ...
    public static final String REDIRECT_URL = "https://open.cuuxx.com";
    ...
    public RedirectView callBack(@RequestParam String code) {
        try {
            // 通过我们生成的code去微信拿access_token
            WxOAuth2AccessToken accessToken = wxService.getOAuth2Service().getAccessToken(code);
            // 然后通过access_token去拿用户信息
